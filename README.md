...
Dont have functionality to display but I do have a lot of the handlers done for the functionality (my work flow was a little weird)
...
Yes but I started the project late because of issues with my lab so I will be using the extension to finish it
